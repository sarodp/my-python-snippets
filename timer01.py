...
def main():
    ...
    while True: # for each frame
        ...
        x0 = 20
        screen.blit(time_display, (x0, 10))
        screen.blit(rawtime_display, (x0, 35))
        screen.blit(fps_display, (x0, 60))
        screen.blit(pygame_total_ticks_display, (x0, 85))
        screen.blit(seconds_display, (x0, 110))
